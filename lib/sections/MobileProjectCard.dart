...
class MobileProjectCard extends StatefulWidget {
  ...
  String codeLink;
  MobileProjectCard(this.title,this.description,this.backgroundImage,this.codeLink,{Key? key}) : super(key: key);

  @override
  State<MobileProjectCard> createState() => _ProjectCardState();
}
